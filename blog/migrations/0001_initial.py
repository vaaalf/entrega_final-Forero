# Generated by Django 4.2.11 on 2024-04-28 23:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entradas', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comentario',
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('entrada', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comentarios_entrada', to='blog.entrada')),
